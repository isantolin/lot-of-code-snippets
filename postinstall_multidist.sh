...
if [ "$DIST" == "Ubuntu" ] || [ "$DIST" == "Raspbian GNU/Linux" ]; then
  ...
  sudo flatpak install flathub io.dbeaver.DBeaverCommunity com.jetbrains.PyCharm-Professional -y
  
  # No instalar Pycharm de Flatpak porque tiene problemas usar el de Snap (Pero ir probando para las proximas versiones)
